        ...
        <div class="row">
            <div class="col-12">
                <div class="app-card d-flex flex-column shadow-sm">
                    ...
                    <form class="settings-form" action="{{ route('dosen.akademik.store', $kuesioner->id) }}" method="POST">
                        @csrf
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#select-matkul").select2({
                ...
                theme: 'bootstrap-5',
                ajax: {
                    url: `{{ route('api.dosen.mata-kuliah', $kuesioner->id) }}`,
                    dataType: "json",
                    type: "POST",
                    data: function(params) {
                        return {
                            csrfToken: $('meta[name="csrf-token"]').attr('content'),
                            nodos: "{{ $userSession['nodosMSDOS'] }}",
