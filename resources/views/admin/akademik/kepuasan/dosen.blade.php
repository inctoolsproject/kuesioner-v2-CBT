...
@section('content')
    <div class="container-xl">
        ...
        <h1 class="app-page-title">Kepuasan Dosen Per Prodi</h1>
        @if (session('success'))
        ...
        <div class="app-card alert shadow-sm mb-4 border-left-decoration">
            <div class="inner">
                <div class="app-card-body p-3 p-lg-4">
                    <h3 class="mb-3">Kepuasan Dosen Per Prodi</h3>
    ...
    <script>
        $(document).ready(function() {
            ...
            let table = $('#kuesioner-table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('admin.akademik.kepuasan.dosen.list') }}",
                    data: function(d) {
            ...
            $("#export").on('click', function(e) {
                ...
                window.open("{{ route('admin.akademik.kepuasan.dosen.export') }}?filter1=" + filter1,
                    '_blank');
            })
