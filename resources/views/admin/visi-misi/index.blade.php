            ...
            <div class="inner">
                <div class="app-card-body p-3 p-lg-4">
                    ...
                    <div class="row gx-5 gy-3">
                        <div class="col-12">
                            <div>
                                Kuesioner ini menanyakan pendapat Anda mengenai visi misi dan tujuan di Itenas.
                            </div>
                            <div class="float-end">
                                <a href="{{ route('admin.visi-misi.create') }}" class="mt-3 btn btn-lg app-btn-primary">Buat
                                    Kuesioner</a>
                            </div>
                        </div>
                        <!--//col-->
    ...
    <script>
        $(document).ready(function() {
            ...
            let table = $('#kuesioner-table').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ route('admin.visi-misi.list') }}",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
            ...
            $('#kuesioner-table').on('click', '.hapus_record', function(e) {
                ...
                Swal.fire({
                    title: 'Apakah Yakin?',
                    text: `Apakah Anda yakin ingin menghapus kuesioner visi-misi dengan judul : ${name}`,
                    icon: 'warning',
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                Swal.fire(
                                    'Deleted!',
                                    `Kuesioner visi-misi dengan judul : ${name} berhasil terhapus.`,
                                    'success'
                                )
