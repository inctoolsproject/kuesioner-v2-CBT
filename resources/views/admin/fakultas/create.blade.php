        ...
        <div class="app-card alert shadow-sm mb-4 border-left-decoration">
            <div class="inner">
                <div class="app-card-body p-3 p-lg-4">
                    <h3 class="mb-3">Buat Kuesioner Fakultas
                    </h3>
                    <div class="row gx-5 gy-3">
                        <div class="col-12">
                            <div>Kuesioner ini akan dibuat dengan template pertanyaan dan jawaban yang telah disetting
                                sebelumnya.
                            </div>
                        </div>
                        <!--//col-->
        ...
        <div class="row">
            <div class="col-12">
                <div class="app-card d-flex flex-column shadow-sm">
                    ...
                    <form class="settings-form" action="{{ route('admin.fakultas.store') }}" method="POST">
                        @csrf
