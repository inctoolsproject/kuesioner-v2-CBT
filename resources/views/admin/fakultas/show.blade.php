            ...
            <div class="inner">
                <div class="app-card-body p-3 p-lg-4">
                    ...
                    <div class="row gx-5 gy-3">
                        <div class="col-12">
                            <div>Kuesioner ini menanyakan pendapat anda mengenai pelayanan fakultas terhadap tenaga
                                pendidik. Pengumpulan data menggunakan kuesioner ini bertujuan mengukur keefektifan
                                pelayanan fakultas yang telah dilakukan. Berikan tanggapan berdasarkan pendapat sendiri dan
                                bukan pandangan/pendapat orang lain.
                            </div>
                        </div>
                        <!--//col-->
                    </div>
